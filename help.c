...
static char *yowzitch_items[] = {
    ...
    "1+-s,", "1---list-scores ",
             "1!Display scores for the named level set and exit.",
    "1+-t,", "1---list-times ",
             "1!Display times for the named level set and exit.",
    "1+-b,", "1---batch-verify ",
             "1!Verify solutions for the named level set and exit.",
    "1+-d,", "1---list-dirs ",
...
void onlinecontexthelp(int topic)
{
	...
	" buttons to move the selection. When the level set of your choice"
	" is selected, press X to begin.",
	"1-",
	"1!If the list is long, you may also use the PgUp and PgDn keys to"
	" scroll one windowful at a time.",
	"1-",
	"1!At any point in the program, you may press O to quit the"
	" current activity and go back up one step."
	" Pressing Start at any time will bring up a list of help topics.",
	"1-",
	...
	" using this program.",
	"1-",
	"1!Now, press any button to go back to the list of level sets."
    };
