...
tablespec const *keyboardhelp(int which)
{
	...
	"1-Dpad", "1-move Chip",
	"1-O (twice)", "1-quit the current game",
	"1-Start", "1-pause the game / view help",
	"1-Square", "1-restart the current level",
	"1-L", "1-jump to the previous level",
	"1-R", "1-jump to the next level",
    };
    static tablespec const keyhelp_ingame = { 6, 2, 4, 1, ingame_items };

    static char *twixtgame_items[] = {
	"1-L", "1-jump to the previous level",
	"1-R", "1-jump to the next level",
	"1-Select", "1-scores/change level",
	"1-Triangle", "1-toggle stepping offset",
	"1-O", "1-return to the file list",
    };
    static tablespec const keyhelp_twixtgame = { 5, 2, 2, 1,
						 twixtgame_items };
